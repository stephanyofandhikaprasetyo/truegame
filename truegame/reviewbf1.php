...
<nav class="navbar">
    ...
    <div class="container">
        <a href="index.php">Home</a>
    	<div class="card">
    		<div class="card-header">Battlefield 1</div>
    		<div class="card-body">
    			<div class="row">
    				<div class="col-sm-4 text-center">
    					<h1 class="text-warning mt-4 mb-4">
                            <img src="img/battlefield_PNG4.png" alt="" style="width:300px;">
                            <br>
  	...
  	<div class="modal-dialog" role="document">
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
                ...
                <input type="text" class="form-control" name="username" id="username" value="nick" readonly>
	        	</div>
	        	<div class="form-group">
